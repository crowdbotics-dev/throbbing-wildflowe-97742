...
## Project Structure
    ...
    ├── throbbing_wildflowe_97742  # Django project configurations
...
1. Clone this repo and `cd throbbing_wildflowe_97742`
...
2. Clone this repo and `cd throbbing_wildflowe_97742`
